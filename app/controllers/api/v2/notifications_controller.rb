...
class Api::V2::NotificationsController < Api::BaseController
  ...
  def load_notifications
    MastodonOTELTracer.in_span('Api::V2::NotificationsController#load_notifications') do
      notifications = browserable_account_notifications.includes(from_account: [:account_stat, :user], nudge_message: [:media_attachment, :voice_attachment], media_tag: { media_attachment: { status: :account } }).to_a_grouped_paginated_by_id(
